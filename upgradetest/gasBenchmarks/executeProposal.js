...
contract('Gas Benchmark - [Execute Proposal]', async (accounts) => {
    ...
    before(async () => {
        ...
        await Promise.all([
            await upgrades.deployProxy(await ethers.getContractFactory("BridgeUpgradeable"), domainID, initialRelayers, relayerThreshold, 0, 100, ETHresourceID, weth.address).then(instance => BridgeInstance = instance),
        ...
        await Promise.all([
            ...
            ERC1155MintableInstance.mintBatch(depositerAddress, [erc1155TokenID], [erc1155TokenAmount], Ethers.constants.HashZero),
