...
contract('Bridge - [deposit - ETH]', async (accounts) => {
    ...
    beforeEach(async () => {
        ...
        BridgeInstance = await upgrades.deployProxy(await ethers.getContractFactory("BridgeUpgradeable"), originDomainID, [], relayerThreshold, 0, 100, ETHresourceID, WethInstance.address)
