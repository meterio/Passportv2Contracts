...
contract('Bridge - [deposit - ERC721]', async (accounts) => {
    ...
    beforeEach(async () => {
        ...
        await Promise.all([
            ...
            await upgrades.deployProxy(await ethers.getContractFactory("BridgeUpgradeable"), originDomainID, [], 0, 0, 100, ETHresourceID, weth.address).then(instance => BridgeInstance = instance)
        ]);
