...
contract('Bridge - [deposit - Generic]', async () => {
    ...
    beforeEach(async () => {
        ...
        await Promise.all([
            ...
            BridgeInstance = await upgrades.deployProxy(await ethers.getContractFactory("BridgeUpgradeable"), originDomainID, [], 0, 0, 100, ETHresourceID, weth.address).then(instance => BridgeInstance = instance)
        ]);
