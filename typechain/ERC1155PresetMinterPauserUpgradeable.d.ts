...
export class ERC1155PresetMinterPauserUpgradeable extends Contract {
  ...
  initialize(uri: string, overrides?: Overrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    ...
    initialize(uri: string, overrides?: Overrides): Promise<BigNumber>;
