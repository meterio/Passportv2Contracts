...
export interface ERC1155HandlerUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface ERC1155HandlerUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC1155HandlerUpgradeableInterface;
