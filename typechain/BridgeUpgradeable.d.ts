...
interface BridgeUpgradeableInterface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize(uint8,address[],uint256,uint256,uint256,bytes32,address)": FunctionFragment;
    ...
    "voteProposals(uint8,uint64,bytes32,bytes,uint256,bytes[])": FunctionFragment;
  };
...
export class BridgeUpgradeable extends Contract {
  ...
  functions: {
    ...
    "initialize(uint8,address[],uint256,uint256,uint256,bytes32,address)"(
      domainID: BigNumberish,
      initialRelayers: string[],
      initialRelayerThreshold: BigNumberish,
      fee: BigNumberish,
    ...
    "voteProposals(uint8,uint64,bytes32,bytes,uint256,bytes[])"(
      domainID: BigNumberish,
      depositNonce: BigNumberish,
      resourceID: BytesLike,
      data: BytesLike,
