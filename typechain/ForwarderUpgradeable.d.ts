...
interface ForwarderUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class ForwarderUpgradeable extends Contract {
  ...
  interface: ForwarderUpgradeableInterface;
